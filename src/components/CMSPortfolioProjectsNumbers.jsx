...
function CMSPortfolioProjectsNumbers() {
  ...
  const fetchStats = async () => {
    try {
      ...
      const filteredStats = data.data.filter(stat => stat.page === "portfolio-projects");
  ...
  return (
    <div className="cms-banner-container">
      <div className="cms-banner-header">
        <h1 className="cms-banner-title">Portfolio Projects Numbers</h1>
      </div>
...
export default CMSPortfolioProjectsNumbers;
