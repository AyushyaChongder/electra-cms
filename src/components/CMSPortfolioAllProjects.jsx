...
const data = [
  ...
  {
    title:
      "Luxury living redefined through reliable electrical innovations with RDS Legacy Apartments",
    images: [
      {
        url: app1,
        alt: "Modern high-rise apartment building, RDS Legacy, showcasing Electrapower Engineering's electrical project expertise.",
      },
      {
        url: app2,
        alt: "Elegant rooftop terrace at RDS Legacy apartments with illuminated pergola and landscaped greenery, highlighting Electrapower Engineering's electrical solutions.",
      },
      {
        url: app3,
        alt: "Rooftop pool and lounge area at RDS Legacy apartments with stylish lighting, showcasing Electrapower Engineering's electrical installations.",
      },
    ],
    description_one:
      "Electra Power Engineering has partnered with RDS Realties Ltd., a renowned builder in Kerala, to illuminate their prestigious RDS Legacy Apartments project in Kochi. Recognized for their commitment to quality and luxury, RDS Realities entrusted Electra Power with the turnkey electrical design and installation for this landmark residential development.",

    description_two:
      "Our team's expertise ensured that RDS Legacy Apartments residents enjoy uninterrupted power supply, state-of-the-art electrical amenities, and a seamless living experience. The project demonstrates our ability to deliver comprehensive electrical solutions for high-end residential projects, aligning perfectly with the builder's vision of luxury and comfort.",
  ...
  {
    title:
      "Empowering healthcare with cutting-edge electrical infrastructure for Kerala's First Nuclear Medicine Center",
    images: [
      {
        url: hos1,
        alt: "Exterior view of Imaging Lily, Kerala's first nuclear medicine center, highlighting Electrapower Engineering's electrical project contribution.",
      },
      {
        url: hos2,
        alt: "Advanced medical imaging equipment in a bright, modern room at Kerala's first nuclear medicine center, showcasing Electrapower Engineering's electrical work.",
      },
      {
        url: hos3,
        alt: "Clean, well-lit reception area of Kerala's first nuclear medicine center, showcasing Electrapower Engineering's electrical installations.",
      },
    ],
    description_one:
      "Electra Power Engineering, a  pioneer in electrical contracting and engineering, partnered with Imaging Lily Pvt. Ltd. to illuminate the future of healthcare in Kerala. We were entrusted with the turnkey electrical design and installation for Kerala's first all-inclusive nuclear medicine and radiology centre, located in the heart of Kochi.",

    description_two:
      "Imaging Lily is a pioneering institution dedicated to providing comprehensive diagnostic and treatment services for a wide range of medical conditions. Electrapower's role was instrumental in creating a safe, reliable, and efficient electrical infrastructure that supports the centre's critical operations and advanced medical equipment. This project exemplifies our expertise in designing and implementing electrical solutions for healthcare facilities, where precision, reliability, and safety are paramount.",
  ...
  {
    title:
      "Transforming mat manufacturing with advanced electrical upgrades for Travancore Cocotuft",
    images: [
      {
        url: coco1,
        alt: "Exterior of Travancore Cocotuft factory building with loading docks, showcasing Electrapower Engineering's electrical project involvement.",
      },
      {
        url: coco2,
        alt: "Large factory interior with machinery and rolls of material, showcasing Electrapower Engineering's electrical work at Travancore Cocotuft.",
      },
      {
        url: coco3,
        alt: "Travancore Cocotuft entrance with company logo and lush greenery, showcasing Electrapower Engineering's electrical project contribution.",
      },
    ],
    description_one:
      "Electra Power Engineering collaborated with Travancore Cocotuft (P) Ltd., the world's largest doormat manufacturer and exporter, to upgrade their electrical infrastructure. Acknowledging the necessity for a robust and sustainable power solution to support their extensive manufacturing operations, Travancore Cocotuft relied on Electra Power to design, install, and commission a state-of-the-art electrical system.",
  ...
  {
    title:
      "Spicing up production with enhanced electrical infrastructure for Eastern Condiments",
    images: [
      {
        url: ec1,
        alt: "Exterior view of Eastern Condiments factory complex with administrative building and landscaped driveway, highlighting Electrapower Engineering's electrical project contribution.",
      },
      {
        url: ec3,
        alt: "Exterior view of Eastern Condiments factory complex with overhead pipes, safety markings, and a parked car, showcasing Electrapower Engineering's electrical work.",
      },
      {
        url: ec2,
        alt: "Large industrial building of Eastern Condiments with loading docks and safety markings, showcasing Electrapower Engineering's electrical project contribution.",
      },
    ],
    description_one:
      "Electra Power Engineering, a trusted leader in electrical contracting and engineering, partnered with Eastern Condiments, India's largest spice exporter and a major player in the food industry, to enhance their electrical infrastructure. As a renowned brand backed by Orkla, Eastern Condiments sought a robust and efficient electrical system to support their expanding production lines for Masala and Roaster products.",

    description_two:
      "Recognizing the critical role of reliable power in maintaining production efficiency and product quality, Eastern Condiments entrusted Electra Power with the electrification of their Masala plant and Roaster. This project demonstrates our expertise in designing and implementing electrical solutions for large-scale manufacturing facilities, ensuring uninterrupted operations and adherence to industry standards.",
  ...
  {
    title:
      "Preserving heritage with electrifying solutions at Chungath Group's luxury resort, Napier Heritage",
    images: [
      {
        url: napier1,
        alt: "Colonial-style building with a red tiled roof and wooden accents, showcasing Electrapower Engineering's electrical work at Napier Heritage.",
      },
      {
        url: napier2,
        alt: "Tranquil poolside scene at Napier Heritage hotel with illuminated colonial architecture, showcasing Electrapower Engineering's electrical solutions.",
      },
      {
        url: napier3,
        alt: "Courtyard of Napier Heritage hotel with illuminated walkways and traditional architecture, showcasing Electrapower Engineering's electrical solutions.",
      },
    ],
    description_one:
      "We partnered with Napier Heritage, a prestigious heritage resort owned by the renowned Chungath business group, to enhance its electrical infrastructure. Located in the heart of historic Fort Kochi, Napier Heritage seamlessly blends exquisite Dutch-Portuguese grandeur with modern comforts.",

    description_two:
      "Electra Power Engineering was entrusted with the turnkey electrical design and installation for this iconic property. Our team's expertise ensured that the resort's historical charm was preserved while providing a state-of-the-art electrical system that met the demands of a modern luxury hotel. This project exemplifies our ability to deliver tailored electrical solutions for hospitality establishments, where aesthetics, functionality, and reliability are paramount.",
  ...
  {
    title:
      "Driving Kerala forward with TATA Motors' first exclusive EV showroom with Luxon Motors pvt Ltd",
    images: [
      {
        url: tata1,
        alt: "Illuminated Tata Motors showroom at night, showcasing Electrapower Engineering's electrical project for Luxon Motors.",
      },
    ],
    description_one:
      "Electra Power Engineering, pioneers in electrical contracting and engineering, partnered with Luxon Motos Pvt. Ltd., the largest Tata Motors dealer in Kerala, to illuminate the future of mobility. We were entrusted with the electrical design and installation of Kerala's first exclusive TATA Motors EV showroom in Palarivattom, Kochi.",
